                ...
                <div className="bg-white rounded-xl shadow-md p-4 border-l-4 border-yellow-500">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-3xl font-bold text-gray-900">{displayAverage}</p>
                        </div>
                ...
                <div className="bg-white rounded-xl shadow-md p-4 border-l-4 border-green-500">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-3xl font-bold text-gray-900">{displayReviews.length}</p>
                        </div>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden">
                ...
                <div className="flex border-b border-gray-200">
                    <button
                        ...
                        className={`flex-1 px-5 py-3 text-sm font-medium text-center transition-colors ${activeTab === "given"
                    ...
                    <button
                        ...
                        className={`flex-1 px-5 py-3 text-sm font-medium text-center transition-colors ${activeTab === "received"
